...
root.config(bg = 'SlateGray1')
root.title('Priya-AddressBook')
root.resizable(0,0)
contactlist = [
    ['Neha',  '0176738493'],
    ['Pulkit Sharma',  '2684430000'],
    ['Mayank Kabra',   '4128354432'],
    ['Trisha Todi','6834896741'],
    ['Rahul Singh',   '1234908689'],
    ['Jitender Kumar' , '211986543'],
    ]
